 ...
 */
  ...
  //fs.writeSlotValue( "member", "height", new Integer( 170 ) );
  
  //Daisukeというインスタンスフレームをmemberフレームから作成
  fs.createInstanceFrame( "member", "Daisuke" );
  //Daisukeのスロットにデータを書く
  fs.writeSlotValue( "Daisuke", "height", new Integer( 172 ) );
  /*
  if(fs.readSlotValue( "Daisuke", "height", false ) instanceof Integer){
